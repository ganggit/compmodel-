 ...
 * ===============================================================================
 * Compile: mex -g -I./ mexc_complearn.cpp complearn.cpp util.cpp filter.cpp checkparts.cpp
 ...
 * Runing Example: model = mexc_complearn(data,layers, 2, 1,6,10, 0.9, [2 1 1 1 0.5 0.2 0.1], 0.9);
 * ===============================================================================
 *
                 ...
                 int nrhs, const mxArray *prhs[])                
{
    ...
    */
    ...
    Parts* model = new Parts[numlayer+1];
    layers = prhs[1];
    ...
    {
        model[jstruct].ptypes_ = new pTypes[numsub];
        model[jstruct].ntypes_ = new int[numsub];
        ...
        for(jstruct=0; jstruct<numlayer; jstruct++)
        {
            ...
            else
            {
               ...
               if(ncells>0)
               {
                   ...
                   model[jstruct].plinks_ = new array1d[ncells];
                   // new array1d[ncells];
                   for (i=0; i<ncells; ++i)
                   {
     ...
     * =============================================
     */
    learningcomposition(examples, numdata, model, numlayer,numsub, numOrient, radius, percent, param, discount);
