 ...
 * ===============================================================================
 * Compile: mex -g -I./ mexc_compinference.cpp compinference.cpp util.cpp filter.cpp checkparts.cpp
 ...
 * Runing Example: Output = mexc_compinference(data,layers, 2, 1,4,10, 0.9, [2 1 1 1 0.5 0.2 0.1], 0.9);
 * ===============================================================================
 *
                 ...
                 int nrhs, const mxArray *prhs[])                
{
    ...
    */
    ...
    //for(ifield = 0; ifield<NUM_FIELD_LAYERS; ifield++)
        for(jstruct=0; jstruct<NUM_OF_LAYER; jstruct++)
        {
            ...
            else if(ptypes!=NULL)
            {
               ...
               if((mxGetNumberOfElements(ptypes)>numsub)&&model[jstruct].ptypes_[numsub].ntypes>0 && jstruct==numlayer)
                   flag = true;
            }
            else
            {
    ...
    mexPrintf("the # sub-composition: %d\n", numsub);
    struct Data *output;
