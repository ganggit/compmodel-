...
struct pTypes{
    vector<double_array1d> dyx; // parts' ID and relative postions
...
void meanvariance(int* dataPoints, int numdata, double* mean, double* var);
...
struct array1d searchneighs(int ptid, double *pdist, int ninst, int radius, int pre_radius, int numlayer);
